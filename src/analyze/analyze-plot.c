...
int verb_plot(int argc, char *argv[], void *userdata) {
        ...
        _cleanup_(json_variant_unrefp) JsonVariant *root = NULL;
        _cleanup_free_ char *pretty_times = NULL;
        bool use_full_bus = arg_scope == LOOKUP_SCOPE_SYSTEM;
        int json_output = arg_json_format_flags & (JSON_FORMAT_PRETTY|JSON_FORMAT_PRETTY_AUTO|JSON_FORMAT_NEWLINE);
        //JsonVariant **traces = NULL;
        BootTimes *boot;
        UnitTimes *u;
        int n, m = 1, y = 0, r;
        double width;
